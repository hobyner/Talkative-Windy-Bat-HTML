    ...
    <header id="header" class="full-header header-size-sm">
        <div id="header-wrap">
            <div class="container">
                ...
                ============================================= -->
                    <div id="logo">
                        <a href="{{route('landing')}}" class="standard-logo"><img src="{{asset('img/logo.png')}}"
                                                                                  alt="Logo"></a>
                        <a href="{{route('landing')}}" class="retina-logo"><img src="{{asset('img/logo.png')}}"
                                                                                alt="Logo"></a>
                    </div><!-- #logo end -->
                    ...
                    <div class="header-misc">
                        ...
                        @else
                            <div class="mx-3 me-lg-0">
                                <a href="{{route('login')}}">
                                    <button type="button" class="btn btn-primary btn-md"><b>LOGIN</b></button>
                                </a>
                            </div>
                        @endauth
                    </div>
                                ...
                                @if(auth()->user()->is_admin)
                                    <li class="menu-item">
                                        <a class="menu-link" href="{{route('dashboard')}}">
                                            <div style="color: red;"><strong>ADMIN</strong></div>
                                        </a>
                                    </li>
                                @endif
                                <li class="menu-item">
                                    ...
                                    <ul class="sub-menu-container mega-menu-dropdown">
                                        ...
                                        <li class="menu-item">
                                            <a class="menu-link" href="#">
                                                <div>My Investors</div>
                                            </a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="menu-link" href="#">
                                                <div>Investor Search</div>
                                            </a>
                                        </li>
                                        <li class="menu-item">
                                            <a class="menu-link" href="#">
